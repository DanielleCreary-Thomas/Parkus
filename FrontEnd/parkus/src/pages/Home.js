...
import { getCurrUser, fetchUser, getGroupMembers, fetchGroupMembersSchedules } from '../services/requests';
        ...
        if (userData) {
          ...
          if (userData.groupid) {
            ...
            try {
              ...
              if (membersData) {
                // Ensure the members have valid names
            ...
            try {
              ...
              if (schedulesData) {
                ...
                const todaySchedules = schedulesData.filter(block => block && normalizeDow(block.dow) === currentDay);
